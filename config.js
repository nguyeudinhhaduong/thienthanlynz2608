...
const eventName = 'Chúc Mừng 8-3 thiên thần của em';
const titleCard = 'Tặng người ấy';
const contentCard = 'Chúc thiên thần Bích Liên của tràn ngập niềm vui và những nụ cười. Mong điều đẹp nhất sẽ đến với chị trong hôm nay và cả những ngày sau';
